...
The author is no expert in Japanese grammar, but he did learn quite a bit while
_creating_ this system. Errors are likely.
...
The Japanese word for "sentence" is <ruby>文章<rp>(</rp><rt>ぶんしょう</rt><rp>)</rp></ruby> (bunshou, literally "writing section"). One word for
