...
identical. They both can mean "what we're currently talking about".
...
- The word _topic_ is reserved for "what we're currently talking about". It
  simply provides overall context. A _topic_ might be explicit (actually
  mentioned within a sentence) or explicit (from prior sentences or based on
  where a conversation is occurring). A sentence might mean different things in
  different contexts. The _topic_ clarifies what specific meaning was intended.
...
Japanese, however, uses explicit topics all the time. This leads to much
confusion for English-speaking language learners, since even extremely simple
and incredibly common sentences contain explicit _topics_ but only implicit
_subjects_.
...
The character 私 in this sentence is the _topic_ "me" and _not_ the grammatical
...
<Figure caption='"I am an American" in Japanese'>
...
<Figure caption="Every Sunday, my father makes sushi">
