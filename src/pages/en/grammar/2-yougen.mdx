...
1. They _conjugate_ or _inflect_.
   ...
   Examples: [読む](/en/diagramming/basics#yomu)・読まない・読みます・読めば・...

2. They are freestanding words that can form a 述語 (predicate).

   Examples: [本を **{読む}^(述語)**](/en/diagramming/basics#honwoyomu).
...
1. They can form the {述語}^(じゅつご) (predicate):
   ...
   - [花が **{咲いた}^(述語)**](/en/diagramming/basics#hanagasaita)

2. They can become {修飾語}^(しゅうしょくご) (modifiers):

   Examples:

   - [**{歩く}^(修飾語)** 習慣を身につける](/en/diagramming/basics#arukushuukan_svg)

     Translation: "[I] acquire [the] **walking** habit"

   - [早く **{起きるように}^(修飾語)** 努力する](/en/diagramming/basics#hayakuokiru_svg)
