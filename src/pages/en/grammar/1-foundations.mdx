...
<Definition>
  ...
  <span>
    Writing in general (an article, composition, essay, or, an individual
    _sentence_.)
  </span>
</Definition>
...
<Definition>
  ...
  <span>A paragraph. Literally, "falling rows" of text.</span>
</Definition>

<Definition>
  <span slot="term">{文}^(ぶん)</span>
  <span>A sentence (something that can be delimited with a period.)</span>
</Definition>

<Definition>
  <span slot="term">{文節}^(ぶんせつ)</span>
  <span>An individual clause or phrase within a sentence.</span>
</Definition>

<Definition>
  <span slot="term">{単語}^(たんご)</span>
  <span>An individual word.</span>
</Definition>
