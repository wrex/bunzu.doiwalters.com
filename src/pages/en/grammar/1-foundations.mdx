...
- **{文章}^(ぶんしょう)** Means writing in general (an article, composition, essay, or,
  an individual _sentence_.)

- **{段落}^(だんらく)** A paragraph. Literally, "falling rows" of text.

- **{文}^(ぶん)** A sentence (that can be delimited with a period.)

- **{文節}^(ぶんせつ)** An individual clause or phrase within a sentence.

- **{単語}^(たんご)** An individual word.
...
2. 体言 modifiers/qualifiers: [{連体詞}^(れんたいし)](/en/grammar/3-non-yougen#%E9%80%A3%E4%BD%93%E8%A9%9E%E3%82%8C%E3%82%93%E3%81%9F%E3%81%84%E3%81%97-pre-noun-adjectives)
   ("pre-noun adjectives")
