...
<Definition>
  ...
  <span>Noun. (Literally: a "named part of speech".)</span>
</Definition>

<Definition>
  <span slot="term">{動詞}^(どうし)</span>
  <span>Verb. (Literally: a "movement/change part of speech.)</span>
</Definition>
...
The following diagram provides an excellent synopsis for the remainder of this
section. Refer back to it often:
