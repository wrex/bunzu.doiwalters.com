...
<Admonition title="Important">
  _Every_ clause **always** has a logical
  {/* prettier-ignore */}
...
{/* prettier-ignore */}
<ruby>助詞<rp>(</rp><rt>じょし</rt><rp>)</rp></ruby> (particle)「が」that immediately follows.
...
<section class="admonition">
  ...
  <p class="content">
    主語 are often omitted in writing or speech, but <em>something</em>{" "}
    <strong>always</strong> acts as the "master" in <strong>every</strong>{" "}
    clause, even if isn't explicitly mentioned.
  </p>
</section>
...
the word ゆっくり (slowly) is 修飾語 (a modifer) and
{/* prettier-ignore */}
