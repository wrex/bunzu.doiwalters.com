...
- The 主語 is the single word 私 (identified by the particle が). "I" is the master
  doing the action.

- The 述語 is the single verb 食べた (the past tense of 食べる). The action was "ate".

Here is how we'd diagram that sentence:

<Figure caption="私が食べた">
...
- This sentence doesn't use the plain or dictionary form of the 動詞　食べる, it
  uses an inflection (食べた). We use an optional dot to separate the stem of the verb
...
- The core clause along the baseline is still _read_ 「食べた」 -- the stuff in
  brackets is ignored. [Unless we are talking _about the diagram_ rather than
  about the original sentence. In that case, it's helpful to say「『まるが』食べた」 with
...
object to our "I ate" example. Let's diagram "I ate _sushi_" (or, more
accurately, &ldquo;@ ate sushi&rdquo; with an implied "I").

<Figure caption="Objects">![Objects](/images/ex6-objects.png)</Figure>

Notes:

- The original sentence in it's entirety is 「寿司を食べた」, but the _core_
  clause is just 「食べた」. The same clause we looked at earlier ("sushi" just
  adds more information, it tells as _what_ was eaten).

- An English _translation_ of that core clause is impossible without more context.
  We still don't know who or what ate the sushi. We don't know whether to use a
