...
also possible to create single-word sentences out of 体言 (basically nouns) or the two 用言 that
_aren't_ 動詞 (the "is-verbs").

Diagramming the examples from that section:

![Example 5: Implied copula](/images/ex5-cow-quiet-cold.png)
...
![Example 6: Objects](/images/ex6-objects.png)
...
![Example 7: Several modifiers](/images/ex7-white-dog-eating.png)
