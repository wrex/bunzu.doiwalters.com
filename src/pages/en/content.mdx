...
{/* prettier-ignore */}
The English word "noun" and the Japanese word <ruby>名詞<rp>(</rp><rt>めいし</rt><rp>)</rp></ruby> have pretty much identical meanings: "named things".
...
{/* prettier-ignore */}
> <ruby>動詞<rp>(</rp><rt>どうし</rt><rp>)</rp></ruby>, <ruby>形容詞<rp>(</rp><rt>けいようし</rt><rp>)</rp></ruby>, and <ruby>形容動詞<rp>(</rp><rt>けいようどうし </rt><rp>)</rp></ruby> are all <ruby>活用語 <rp>(</rp><rt>かつようご</rt><rp>)</rp></ruby> (conjugation vocabulary) or <ruby>用言<rp>(</rp><rt>ようげん</rt><rp>)</rp></ruby> (inflecting words). They are all words that describe action or state in the <ruby>述語<rp>(</rp><rt>じゅつご</rt><rp>)</rp></ruby> (predicate) of a sentence.
...
Japanese dictionaries usually identify 形容動詞 as "**だ**-words", but we consider them
"な-words"!
